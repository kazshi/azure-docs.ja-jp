...
容量ユニットの価格 = 744 (時間) * Max (1 秒間の接続数に対する 25/50 コンピューティング ユニット, スループットに対する 8.88/2.22 容量ユニット) * $0.008 = 744 * 4 * 0.008 = $23.81
...
容量ユニットの価格 = 744 (時間) * Max (1 秒間の接続数に対する 0/50 コンピューティング ユニット, スループットに対する 0/2.22 容量ユニット) * $0.008 = 744 * 50 * 0.008 = $297.60
...
容量ユニットの価格 = 744 (時間) * Max (1 秒間の接続数に対する 25/50 コンピューティング ユニット, スループットに対する 125/2.22 容量ユニット) * $0.008 = 744 * 57 * 0.008 = $339.26
...
容量ユニットの価格 = 744 (時間) * Max (コンピューティング ユニット Max(1 秒間の接続数に対する 25/50、80/10 WAF RPS),スループットに対する 8.88/2.22 容量ユニット) * $0.0144 = 744 * 8 * 0.0144 = $85.71
